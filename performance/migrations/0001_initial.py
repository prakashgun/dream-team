    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bowling_style', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='performance.bowlingstyle')),
                ('player_type', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='performance.playertype')),
            ],
        ),
        migrations.CreateModel(
            name='Match',
            fields=[
                ...
                ('ground', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='performance.ground')),
                ('match_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='performance.matchtype')),
                ('tournament', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='performance.tournament')),
            ],
            options={
